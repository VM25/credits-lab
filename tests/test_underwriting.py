...
def test_grade_and_decision_bands():
    assert uw.risk_grade(0.05) == "A" and uw.risk_grade(0.14) == "B" and uw.risk_grade(0.45) == "E"
    assert uw.decision(0.10) == "approve" and uw.decision(0.20) == "review" and uw.decision(0.45) == "decline"
